...
**Gate 3 reaberto após nova falha intermitente:** o [parecer independente anterior](https://github.com/tiagodtandrade-ops/meu-financeiro/issues/2#issuecomment-5746490752) e a [CI da `main` após o PR #7](https://github.com/tiagodtandrade-ops/meu-financeiro/actions/runs/35479581803) foram seguidos por [falha G3-05 em teste de fundação](https://github.com/tiagodtandrade-ops/meu-financeiro/issues/9); consulte `docs/PROJECT_STATUS.md` para estado atual. A CI roda em PRs e na `main`; os artefatos de navegador ficam no run correspondente. A versão publicada no GitHub Pages é para avaliação enquanto G3-05 está em investigação.
